...
def run_simulation():
    ...
    try:
        ...
        if ride_model and ride_model.driver_id:
            ...
            if driver_result:
                ...
                print(f"Ride status: {updated_ride.ride_status.value}")
                
                print("\n--- Reached destination ---")
                ride_system.complete_ride(str(ride_model.ride_id))
                ...
                print(f"Does {pham.user_name} have a current ride? {rider_current_ride is not None}")
        else:
    ...
    print("\n===================================================")
    print("        SCENARIO 2: FAM CANCELS HIS RIDE         ")
    print("===================================================")
    try:
        fam = riders[1]
        ...
        if ride_model and ride_model.ride_status != RideStatusEnum.CANCELLED:
            if ride_model.driver_id:
                ...
                if driver_result:
                    ...
                    if final_driver_result:
                        _, final_driver_model = final_driver_result
                        print(f"Is {driver_user.user_name} available now? {final_driver_model.is_available}")
        else:
    ...
    try:
        ...
        if ride_model and ride_model.driver_id:
            ...
            if driver_result:
                ...
                print(f"Current ride status before cancellation: {current_ride.ride_status.value}")
                ...
                print(f"Does {fam.user_name} have a current ride? {rider_current_ride is not None}")
        else:
